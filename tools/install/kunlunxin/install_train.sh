...
install_megatron_lm() {
    ...
    # Install explicit build requirements because release images skip dev.txt.
    ...
    # The pinned source is validated with the vendor Python 3.10 runtime but
    # declares Python >=3.12. Keep this exception immutable and dependency-free
    # so pip cannot replace the vendor torch, Transformer Engine, or FlagCX stack.
